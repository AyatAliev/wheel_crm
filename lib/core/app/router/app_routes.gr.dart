...
import 'package:wheel_crm/features/profile/profile_screen.dart' as _i3;
import 'package:wheel_crm/features/storage/storage_screen.dart' as _i4;
...
class BottomMenuRoute extends _i6.PageRouteInfo<void> {
  const BottomMenuRoute({List<_i6.PageRouteInfo>? children})
      : super(
...
class StorageRoute extends _i6.PageRouteInfo<void> {
  const StorageRoute({List<_i6.PageRouteInfo>? children})
      : super(
          StorageRoute.name,
          initialChildren: children,
        );
